...
public class DactionDstring<__t,__E> extends Daction<__t,__E> {
	Daction<__t,__E> i0;
	public DactionDstring(
	...
	public static <__t,__E> DactionDstring<__t,__E> string(
		final Daction<__t,__E> i0) {
		return new DactionDstring<__t,__E>(
			i0);
	}
}
