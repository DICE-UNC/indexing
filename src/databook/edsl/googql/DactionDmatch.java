...
public class DactionDmatch<__t,__E> extends Daction<__t,__E> {
	java.lang.String i0;
	DmatchTail<__t,__E> i1;
	public DactionDmatch(
		final java.lang.String i0, 
		final DmatchTail<__t,__E> i1) {
	...
	public static <__t,__E> DactionDmatch<__t,__E> match(
		final java.lang.String i0, 
		final DmatchTail<__t,__E> i1) {
		return new DactionDmatch<__t,__E>(
			i0, 
			i1);
	}
}
