...
public class Evaluators {
	...
	try {			
		...
		org.skife.csv.CSVReader rd = new org.skife.csv.SimpleReader();			
		java.util.List<String[]> list = rd.parse(is);			
		return list;			
		...
		org.apache.log4j.Logger.getLogger("googql").error("googql error", e);			
	} finally {			
		try {			
			if(is != null) {			
				is.close();			
			...
			org.apache.log4j.Logger.getLogger("googql").error("googql error", e1);						
		}			
	}						
	return null;			
}
