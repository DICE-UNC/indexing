...
public class DmatchTailDwith<__t,__E> extends DmatchTail<__t,__E> {
	java.lang.String i0;
	Daction<__t,__E> i1;
	public DmatchTailDwith(
	...
	public static <__t,__E> DmatchTailDwith<__t,__E> with(
		final java.lang.String i0, 
		final Daction<__t,__E> i1) {
		return new DmatchTailDwith<__t,__E>(
			i0, 
			i1);
	}
}
